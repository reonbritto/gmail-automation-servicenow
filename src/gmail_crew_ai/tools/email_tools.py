...
def analyze_email_content(email_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        needs_response = _needs_response(subject, sender, body, is_servicenow)
        
        # Determine response type
        response_type = _determine_response_type(subject, body, is_servicenow)
        
        # Determine urgency
        urgency = _determine_urgency(subject, body, priority, is_servicenow)
        
        # Extract key points
        key_points = _extract_key_points(subject, body)
        
        # Suggest tone
        suggested_tone = _suggest_tone(sender, subject, body, is_servicenow)
...
def generate_email_response(email_data: Dict[str, Any], analysis: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        response_content = _generate_response_content(
...
def save_email_results(email_data: Dict[str, Any], analysis: Dict[str, Any], 
...
def _needs_response(subject: str, sender: str, body: str, is_servicenow: bool) -> bool:
...
def _determine_response_type(subject: str, body: str, is_servicenow: bool) -> str:
...
def _determine_urgency(subject: str, body: str, priority: str, is_servicenow: bool) -> str:
...
def _extract_key_points(subject: str, body: str) -> List[str]:
...
def _suggest_tone(sender: str, subject: str, body: str, is_servicenow: bool) -> str:
...
def _generate_response_content(email_data: Dict[str, Any], 
    ...
    main_content = _get_response_template(response_type, email_data)
    
    # Generate closing
    closing = _get_closing(tone)
...
def _get_response_template(response_type: str, email_data: Dict[str, Any]) -> str:
